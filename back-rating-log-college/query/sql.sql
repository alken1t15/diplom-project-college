...
VALUES (1, 4, '2024-04-16', '2024-04-28', 'Тест', 'Назначено',
        'Этот тест предназначен для оценки различных аспектов личности и самопознания. Он включает несколько секций, каждая из которых направлена на анализ различных характеристик личности и личных предпочтений.', 'Самопознание');

insert into home_work (id_groups, id_teacher, start_date, end_date, name, status, description, name_subject)
VALUES (1, 4, '2024-05-16', '2024-05-28', 'Прочитать книгу', 'Назначено',
        'Это задание направлено на всестороннее изучение выбранной книги. Участникам предстоит не только прочитать книгу, но и провести её анализ, подготовив отчет или эссе по заданным параметрам.', 'Самопознание');

insert into home_work (id_groups, id_teacher, start_date, end_date, name, status, description, name_subject)
VALUES (1, 4, '2024-03-16', '2024-03-28', 'Сделать презентацию', 'Назначено',
        'Это задание направлено на развитие навыков создания и проведения презентаций. Участникам предстоит выбрать тему, провести исследование, создать слайды и подготовить устное выступление.', 'Самопознание');

insert into home_work (id_groups, id_teacher, start_date, end_date, name, status, description, name_subject)
VALUES (1, 3, '2024-05-25', '2024-05-30', 'Сделать сайт', 'Назначено',
        'Это задание направлено на развитие навыков веб-разработки, включая планирование, дизайн, программирование и тестирование веб-сайта. Участникам предстоит пройти весь цикл разработки от концепции до реализации.', 'Веб-программирование');
...
VALUES (1, 'Математика', '2024-04-01', 85, 'Ескеева Гулнар'),
       (1, 'Физика', '2024-04-02', 78, 'Дарибаев Советбек'),
       (1, 'Литература', '2024-04-03', 90, 'Умирзакова Гульмайраш'),
       (1, 'История', '2024-04-04', 92, 'Борибаева Айнагүл'),
       (1, 'Биология', '2024-04-05', 87, 'Токбаев Оразкул'),
       (1, 'Химия', '2024-04-06', 80, 'Бексеитова Жадра'),
       (1, 'География', '2024-04-07', 95, 'Жакаев Айхан'),
       (1, 'Иностранный язык', '2024-04-08', 88, 'Дауренбеков Сұнқар'),
       (1, 'Информатика', '2024-04-09', 91, 'Нугуманов Максут'),
       (1, 'Искусство', '2024-04-10', 82, 'Нурлыкаимов Рахат'),
       (1, 'Математика', '2024-04-11', 75, 'Ескеева Гулнар'),
       (1, 'Физика', '2024-04-11', 80, 'Дарибаев Советбек'),
       (1, 'Литература', '2024-04-11', 85, 'Умирзакова Гульмайраш'),
       (1, 'История', '2024-04-11', 90, 'Борибаева Айнагүл'),
       (1, 'Биология', '2024-04-11', 88, 'Токбаев Оразкул'),
       (1, 'Химия', '2024-04-11', 79, 'Бексеитова Жадра'),
       (1, 'География', '2024-04-11', 92, 'Жакаев Айхан'),
       (1, 'Иностранный язык', '2024-04-11', 89, 'Дауренбеков Сұнқар'),
       (1, 'Информатика', '2024-04-11', 93, 'Нугуманов Максут'),
       (1, 'Искусство', '2024-04-11', 81, 'Нурлыкаимов Рахат'),
       (1, 'Информатика', current_date, 85, 'Нугуманов Максут'),
       (1, 'География', current_date, 69, 'Жакаев Айхан'),
       (1, 'Биология', current_date, 40, 'Токбаев Оразкул');
