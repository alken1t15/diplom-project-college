...
VALUES (1, '2023-09-01', 'Пропущено', 'Математика', 3, 9),
       (1, '2023-09-01', 'Пропущено', 'Физика', 4, 9),
       (1, '2023-09-01', 'Без опозданий', 'Основа право', 5, 9),
       (1, '2023-09-01', 'Пропущено', 'Комп сети', 2, 9),
       (1, '2023-09-03', 'Пропущено', 'Физика', 5, 9),
       (1, '2023-09-05', 'Пропущено', 'История', 2, 9),
       (1, '2023-09-07', 'Пропущено', 'Биология', 4, 9),
       (1, '2023-09-09', 'Пропущено', 'География', 1, 9),
       (1, '2023-09-11', 'Пропущено', 'Химия', 3, 9),
       (1, '2023-09-13', 'Пропущено', 'Литература', 5, 9),
       (1, '2023-09-15', 'Пропущено', 'Иностранный язык', 2, 9),
       (1, '2023-09-17', 'Пропущено', 'Искусство', 4, 9),
       (1, '2023-09-19', 'Пропущено', 'Спорт', 1, 9),
       (1, '2023-09-21', 'Пропущено', 'Экономика', 3, 9),
       (1, '2023-09-23', 'Пропущено', 'Психология', 5, 9),
       (1, '2023-09-25', 'Пропущено', 'Политология', 2, 9),
       (1, '2023-09-27', 'Пропущено', 'Религия', 4, 9),
       (1, '2023-09-29', 'Пропущено', 'Философия', 1, 9),
       (1, '2023-09-01', 'Пропущено', 'Астрономия', 3, 9),
       (1, '2023-09-03', 'Пропущено', 'Анатомия', 5, 9),
       (1, '2023-09-05', 'Пропущено', 'Ботаника', 2, 9),
       (1, '2023-09-07', 'Пропущено', 'Зоология', 4, 9);
