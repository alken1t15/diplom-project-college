...
public interface RepositoryOmissions extends JpaRepository<Omissions, Long> {
    ...
    @Query("select o from Omissions  o where o.dateOmissions = ?1 and o.nameObject= ?2 and o.studentsCourse.student = ?3 and o.studentsCourse.course = ?4 and o.filesStudent= null ")
